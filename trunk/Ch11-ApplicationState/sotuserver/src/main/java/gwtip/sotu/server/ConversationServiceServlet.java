...
public class ConversationServiceServlet extends RemoteServiceServlet
    ...
    public ConversationDescriptor startConversation(ConversationDescriptor conversation) throws
            AccessException, SystemException{
        User u = (User) this.getThreadLocalRequest().getSession().getAttribute( StreamServlet.USER );
        try{
